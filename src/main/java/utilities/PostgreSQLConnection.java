...
//                    logger.info(rowRecord.toString());
    ...
    public List<String> fetchRecordWithColumnName(String columnNames, String table_Name, String limitRange) {
        List<String> queryResult = new ArrayList<>();
        String schemaName = (String) GenericFun.getPostgreSQLTableDetails(table_Name, "schema");
        String tableName = (String) GenericFun.getPostgreSQLTableDetails(table_Name, "table");
